...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_position_buffer')) {
        Object.defineProperty(Module['ready'], '_get_position_buffer', { configurable: true, get: function() { abort('You are getting _get_position_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_position_buffer', { configurable: true, set: function() { abort('You are setting _get_position_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_velocity_buffer')) {
        Object.defineProperty(Module['ready'], '_get_velocity_buffer', { configurable: true, get: function() { abort('You are getting _get_velocity_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_velocity_buffer', { configurable: true, set: function() { abort('You are setting _get_velocity_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_acceleration_buffer')) {
        Object.defineProperty(Module['ready'], '_get_acceleration_buffer', { configurable: true, get: function() { abort('You are getting _get_acceleration_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_acceleration_buffer', { configurable: true, set: function() { abort('You are setting _get_acceleration_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_led_buffer')) {
        Object.defineProperty(Module['ready'], '_get_led_buffer', { configurable: true, get: function() { abort('You are getting _get_led_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_led_buffer', { configurable: true, set: function() { abort('You are setting _get_led_buffer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_initialize_particles')) {
        Object.defineProperty(Module['ready'], '_initialize_particles', { configurable: true, get: function() { abort('You are getting _initialize_particles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_initialize_particles', { configurable: true, set: function() { abort('You are setting _initialize_particles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_tick_particles')) {
        Object.defineProperty(Module['ready'], '_tick_particles', { configurable: true, get: function() { abort('You are getting _tick_particles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_tick_particles', { configurable: true, set: function() { abort('You are setting _tick_particles on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _get_position_buffer = Module["_get_position_buffer"] = createExportWrapper("get_position_buffer");

/** @type {function(...*):?} */
var _get_velocity_buffer = Module["_get_velocity_buffer"] = createExportWrapper("get_velocity_buffer");

/** @type {function(...*):?} */
var _get_acceleration_buffer = Module["_get_acceleration_buffer"] = createExportWrapper("get_acceleration_buffer");

/** @type {function(...*):?} */
var _get_led_buffer = Module["_get_led_buffer"] = createExportWrapper("get_led_buffer");

/** @type {function(...*):?} */
var _initialize_particles = Module["_initialize_particles"] = createExportWrapper("initialize_particles");

/** @type {function(...*):?} */
var _tick_particles = Module["_tick_particles"] = createExportWrapper("tick_particles");
...
var _led_grid = Module['_led_grid'] = 1152;
var _particle_positions = Module['_particle_positions'] = 3552;
var _particle_velocities = Module['_particle_velocities'] = 3792;
var _particle_accelerations = Module['_particle_accelerations'] = 4032;
